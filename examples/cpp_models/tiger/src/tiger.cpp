...
public:
      ...
      History& history) const
  {
    ...
    for (int i = history.Size() - 1;
         i >= 0 && history.Action(i) == Tiger::LISTEN;
         i--)
    ...
    string name, string particle_bound_name) const
{
  ...
  {
    bound = new BlindPolicy(
        this, LEFT, CreateParticleLowerBound(particle_bound_name));
  }
  else if (name == "RIGHT")
  {
    bound = new BlindPolicy(
        this, RIGHT, CreateParticleLowerBound(particle_bound_name));
  }
  else if (name == "LISTEN")
  {
    bound = new BlindPolicy(
        this, LISTEN, CreateParticleLowerBound(particle_bound_name));
  }
