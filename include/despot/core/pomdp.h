...
public:
   ...
   */
  virtual bool Step(
      State& state, int action, double& reward, OBS_TYPE& obs) const;
   ...
   */
  virtual double ObsProb(
      OBS_TYPE obs, const State& state, int action) const = 0;
   ...
   */
  virtual Belief* InitialBelief(
      const State* start, std::string type = "DEFAULT") const = 0;
  ...
  virtual ParticleUpperBound* CreateParticleUpperBound(
      std::string name = "DEFAULT") const;
  ...
  virtual ParticleLowerBound* CreateParticleLowerBound(
      std::string name = "DEFAULT") const;
  virtual ScenarioLowerBound* CreateScenarioLowerBound(
      std::string bound_name = "DEFAULT",
      std::string particle_bound_name = "DEFAULT") const;
  ...
  virtual void PrintState(
      const State& state, std::ostream& out = std::cout) const = 0;

  /**
   * Prints an observation.
   */
  virtual void PrintObs(
      const State& state,
      OBS_TYPE obs,
  ...
  virtual void PrintBelief(
      const Belief& belief, std::ostream& out = std::cout) const = 0;
...
public:
   ...
   */
  virtual Belief* Tau(const Belief* belief, int action, OBS_TYPE obs) const = 0;
