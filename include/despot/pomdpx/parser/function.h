...
public:
  ...
  virtual bool SetValue(
      const std::vector<std::string>& keys, const std::vector<double>& values);
  ...
  virtual double ComputeConstrainedMaximum(
      const NamedVar* var, int value) const;
  virtual double ComputeConstrainedMinimum(
      const NamedVar* var, int value) const;
...
public:
  ...
  virtual bool IsIdentityUnderConstraint(
      const NamedVar* var, int value) const = 0;
...
public:
  ...
  virtual bool IsIdentityUnderConstraint(const NamedVar* var, int value) const;
  virtual CPT* CreateNoisyVariant(double noise) const;

  inline virtual double ComputeConstrainedMaximum(
      const NamedVar* var, int value) const
  {
    assert(false);
    return 0.0;
  };
  inline virtual double ComputeConstrainedMinimum(
      const NamedVar* var, int value) const
  {
    assert(false);
    return 0.0;
