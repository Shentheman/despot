...
public:
  ...
  static std::vector<int> ComputeIndexVec(
      const std::vector<Variable*>& vars, int index);
  static std::vector<int> ComputeIndexVec(
      const std::vector<NamedVar*>& vars, int index);
  static std::vector<int> ComputeIndexVec(
      const std::vector<StateVar*>& vars, int index);
  ...
  static bool IsVariableName(
      std::string name, const std::vector<NamedVar>& vars);
  static bool IsVariableName(
      std::string name, const std::vector<StateVar>& vars);
  static bool IsVariableCurrName(
      std::string name, const std::vector<StateVar>& vars);
  static bool IsVariablePrevName(
      std::string name, const std::vector<StateVar>& vars);
};
