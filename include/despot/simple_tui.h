...
const option::Descriptor usage[] = {
    ...
    {E_SIM_LEN,
     ...
     "simlen",
     option::Arg::Required,
     "-s <arg>  \t--simlen <arg>  \tNumber of steps to simulate. (default 90; "
     "0 "
     "= infinite)."},
    {E_RUNS,
     0,
    ...
    // number." },
    // { E_LOG, 0, "", "log", option::Arg::Required, "  \t--log <arg>  \tIPPC
    // log
    // file." },
    {0, 0, 0, 0, 0, 0}};
...
public:
  ...
  Solver* InitializeSolver(
      DSPOMDP* model, std::string solver_type, option::Option* options);
