...
{
  return "@VNode: [depth_=" + to_string(depth_) + ", lower_bound_="
         + to_string(lower_bound_) + ", upper_bound_=" + to_string(upper_bound_)
         + "]@";
}
...
{
  return "#QNode: [lower_bound_=" + to_string(lower_bound_) + ", upper_bound_="
         + to_string(upper_bound_) + ", step_reward=" + to_string(step_reward)
